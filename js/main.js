...
const createMain = ({ 
	...
	main: { genre, rating, description, trailer, slider}}) => {
		...
		const wrapper = getElement('diiv', ['main-content']);
		container.append(wrapper);
	...
	if (trailer) {
		...
		const yutubeImgLink = getElement('a', ['play', 'youtube-modal'],
			{
				href: trailer,
		...
		yutubeImgLink.append(iconPlay);
		wrapper.append(yutubeImgLink);
	}
...
const movieConstructor = (selector, options) => {
	...
	app.style.background = options.background || '';
